...
class ActivitySerializer(ModelSerializer):
    ...
    included_serializers = {
        'blocks': 'tracking.serializers.ActivityBlockSerializer',
        'task':   'projects.serializers.TaskSerializer',
        'user':   'employment.serializers.UserSerializer'
    }
...
class ActivityBlockSerializer(ModelSerializer):
    ...
    included_serializers = {
        'activity': 'tracking.serializers.ActivitySerializer'
    }
