# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-05-16 14:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='timed_subscription.Subscription')),
            ],
        ),
        migrations.AddField(
            model_name='package',
            name='subscription',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='timed_subscription.Subscription'),
        ),
    ]
