...
describe('Integration | Component | weekly overview day', function() {
  ...
  it('renders', function() {
    ...
    this.render(hbs`{{weekly-overview-day day=day expected=expected worktime=worktime}}`)
  ...
  it('fires on-click action on click', function() {
    ...
    this.render(hbs`{{weekly-overview-day day=day expected=expected worktime=worktime on-click=(action (mut clicked) true)}}`)
