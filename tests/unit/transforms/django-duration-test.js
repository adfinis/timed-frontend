...
describe('Unit | Transform | django duration', function() {
  ...
  it('deserializes', function() {
    ...
    expect(transform.deserialize('01:02:03').asMilliseconds()).to.equal(
      moment
        .duration({
          hours: 1,
          minutes: 2,
    ...
    expect(transform.deserialize('1 02:03:04').asMilliseconds()).to.equal(
      moment
        .duration({
          days: 1,
          hours: 2,
    ...
    expect(transform.deserialize('01:02:03.004000').asMilliseconds()).to.equal(
      moment
        .duration({
          hours: 1,
          minutes: 2,
    ...
    expect(transform.deserialize('-1 22:57:57').asMilliseconds()).to.equal(
      moment
        .duration({
          hours: -1,
          minutes: -2,
    ...
    expect(transform.deserialize('-10 22:57:57').asMilliseconds()).to.equal(
      moment
        .duration({
          days: -9,
          hours: -1,
